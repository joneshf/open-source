    let concatSep =
          https://raw.githubusercontent.com/dhall-lang/dhall-lang/9203c77bfa8f96b3bc9a26016da94d27537d13b9/Prelude/Text/concatSep sha256:8c48334a866d62e3e91591f5f0d3d26429e9304aab393d1f50108beb5460bdf7

in  let Dependency : Type = ./Dependency.dhall

in  let dependency = constructors Dependency

in  let PureScript/FileModule
        : Type
...
in  let fileModule
        ...
        =   λ(names : List Text)
          → { file =
                concatSep "/" names ++ ".purs"
            , module =
                concatSep "." names
            }

in  let purescript-prelude-4-1-0
        : List Dependency
        = purescript
          "purescript-prelude"
...
in  let purescript-control-4-1-0
        : List Dependency
        = purescript
          "purescript-control"
...
in  let purescript-effect-2-0-1
        : List Dependency
        = purescript
          "purescript-effect"
          [ fileModule [ "Effect" ]
...
in  let purescript-console-4-2-0
        : List Dependency
        = purescript
          "purescript-console"
